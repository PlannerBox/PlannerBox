...
export class AddAccountRolePermissions1692611502632 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO public."RolePermissions" (id, "role", permissions) VALUES('10d65583-3068-4f76-be90-5234a306f04b'::uuid, 'admin'::public."RolePermissions_role_enum", '{add,update,delete,read,readAll}')`);
        ...
        await queryRunner.query(`INSERT INTO public."RolePermissions" (id, "role", permissions) VALUES('686ed5da-b6fe-468e-93be-fc461542fa0a'::uuid, 'externTeacher'::public."RolePermissions_role_enum", '{read}')`);

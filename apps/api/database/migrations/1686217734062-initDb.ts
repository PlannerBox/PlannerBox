...
export class InitDb1686217734062 implements MigrationInterface {
    name = 'InitDb1686217734062'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Admin" ("id" character varying(50) NOT NULL, "accountId" character varying(50), CONSTRAINT "PK_3a489f4a44372ff150d7924dc3d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "Admin_pkey" ON "Admin" ("id") `);
        await queryRunner.query(`CREATE TABLE "Student" ("id" SERIAL NOT NULL, "accountId" character varying(50), CONSTRAINT "PK_dc3573f6f2de5aa3aefca0c1f1a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "Student_pkey" ON "Student" ("id") `);
        await queryRunner.query(`CREATE TABLE "Teacher" ("id" character varying(50) NOT NULL, "accountId" character varying(50), CONSTRAINT "PK_c089345af0160b3fd7b44f59e61" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "Teacher_pkey" ON "Teacher" ("id") `);
        await queryRunner.query(`CREATE TABLE "Account" ("id" character varying(50) NOT NULL, "username" character varying(255) NOT NULL, "password" character varying(50) NOT NULL, "firstname" character varying(50), "lastname" character varying(50), "email" character varying(255) NOT NULL, "birth" date, "birthPlace" character varying(50), CONSTRAINT "PK_bf68fd30f1adeede9c72a5cac09" PRIMARY KEY ("id"))`);

...
export class AddCourseEntity1696087396843 implements MigrationInterface {
    name = 'AddCourseEntity1696087396843'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Course" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "name" character varying(100) NOT NULL, "startDate" date NOT NULL, "endDate" date NOT NULL, "groupId" uuid, CONSTRAINT "PK_2132e2054a5c04b038320b38c11" PRIMARY KEY ("id"))`);

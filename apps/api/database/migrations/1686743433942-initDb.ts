...
export class InitDb1686743433942 implements MigrationInterface {
    name = 'InitDb1686743433942'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Admin" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "accountId" uuid, CONSTRAINT "PK_3a489f4a44372ff150d7924dc3d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "Admin_pkey" ON "Admin" ("id") `);
        await queryRunner.query(`CREATE TABLE "Student" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "accountId" uuid, CONSTRAINT "PK_dc3573f6f2de5aa3aefca0c1f1a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "Student_pkey" ON "Student" ("id") `);
        await queryRunner.query(`CREATE TABLE "Teacher" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "accountId" uuid, CONSTRAINT "PK_c089345af0160b3fd7b44f59e61" PRIMARY KEY ("id"))`);

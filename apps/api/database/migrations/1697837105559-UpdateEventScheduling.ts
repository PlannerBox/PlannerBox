...
export class UpdateEventScheduling1697837105559 implements MigrationInterface {
    name = 'UpdateEventScheduling1697837105559'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "Course" ADD "startDate" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "Course" DROP COLUMN "endDate"`);
        await queryRunner.query(`ALTER TABLE "Course" ADD "endDate" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);

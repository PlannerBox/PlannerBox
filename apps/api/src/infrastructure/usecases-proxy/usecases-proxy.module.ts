    ...
    return {
      ...
      providers: [
        ...
        },
        {
          ...
          provide: UsecasesProxyModule.SIGNIN_USECASES_PROXY,
          useFactory: (accountRepository: AccountRepository, bcryptService: BcryptService) => new UseCaseProxy(new SignInUseCases(accountRepository, bcryptService))
        }
      ],
      exports: [
        ...
        UsecasesProxyModule.SIGNIN_USECASES_PROXY,
      ],
    };
  }
}